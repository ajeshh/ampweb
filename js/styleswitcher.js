...
$(document).ready(function () {
    var e = ' 	<h2>Style Switcher <a href="#"><i class="icon tyger-settings-streamline-2 white"></i></a></h2>     <div class="content2">     <div class="switcher-box">     <a id="red" class="styleswitch color"></a>    <a id="orange" class="styleswitch color"></a> 	<a id="turquoise" class="styleswitch color"></a>     <a id="green" class="styleswitch color"></a>  <a id="brown" class="styleswitch color"></a> <a id="violet" class="styleswitch color"></a>  </div><!-- End switcher-box -->     <div class="clear"></div>    <div class="clear"></div>     <br> <!--	<a id="reset" class="dark-style">Reset Styles</a>     </div> End content --> 	';
    $(".switcher").prepend(e)
});
