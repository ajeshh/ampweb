$(document).ready(function() {
    ...
    if (e == false) {
        ...
        $("#bg-video-volume").click(function (e) {
            var n = $(this);
            e.preventDefault();
            if (n.hasClass("icon tyger-volume-down-1")) {
                n.removeClass("icon tyger-volume-down-1").addClass("icon tyger-volume-up").attr("title", "Mute");
                t.unmuteYTPVolume();
                t.setYTPVolume(100)
            } else {
                n.removeClass("icon tyger-volume-up").addClass("icon tyger-volume-down-1").attr("title", "Unmute");
                t.muteYTPVolume()
            }
        });
        $("#bg-video-play").click(function (e) {
            var n = $(this);
            e.preventDefault();
            if (n.hasClass("icon tyger-pause-2")) {
                n.removeClass("icon tyger-pause-2").addClass("icon tyger-play-1").attr("title", "Play");
                t.pauseYTP()
            } else {
                n.removeClass("icon tyger-play-1").addClass("icon tyger-pause-2").attr("title", "Pause");
                t.playYTP()
            }
        })
    } else {
